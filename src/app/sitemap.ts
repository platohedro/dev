...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  const entries: MetadataRoute.Sitemap = [
    ...
    { url: absoluteUrl("/d-formacion/matinee"), changeFrequency: "monthly", priority: 0.7 },
    { url: absoluteUrl("/d-formacion/ideatorio"), changeFrequency: "monthly", priority: 0.7 },
    { url: absoluteUrl("/d-formacion/jaquer-escool"), changeFrequency: "monthly", priority: 0.7 },
    { url: absoluteUrl("/d-formacion/amapolas"), changeFrequency: "monthly", priority: 0.7 },
    { url: absoluteUrl("/d-formacion/comunidad"), changeFrequency: "monthly", priority: 0.7 },
