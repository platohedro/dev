...
const history = [
  ["2004", "Inicios", "Platohedro nace como un colectivo audiovisual: queríamos darle voz a una ciudad y un país silenciados en el terror de la violencia.", "/media/2022/02/amazon-3.png"],
  ["2005", "Foco Crítico", "Nuestro primer proyecto, semilla del programa D-Formación: una escuela alternativa de cine y audiovisuales para jóvenes.", "/media/2022/02/fococritico.png"],
  ["2006", "Presentación de cortometrajes", "Platohedro se da a conocer a la ciudad en su lanzamiento oficial.", "/media/2022/03/presenta_colombo.jpg"],
  ["2006", "Sede propia", "Adquirimos la actual sede en el barrio Buenos Aires, una casa para la creación colectiva y colaborativa.", "/media/2022/02/sedepropia.png"],
  ...
  ["2007", "CasAbierta", "Inauguramos la Casa Platohedro con una semana de celebración, exposiciones, charlas, feria y conciertos.", "/media/2022/03/casabierta.gif"],
  ["2007–2008", "El Matinée", "Espacio alternativo con niñxs para apropiarse del barrio desde sus voces, miradas y complicidades.", "/media/2022/03/matinee.jpg"],
  ["2007–2008", "Armar la podrida", "Participación en escenarios clave para la ciudad que abrieron aprendizajes y expansión de redes.", "/media/2022/03/Armar-la-podrida-1.jpg"],
  ["2009–2011", "Moción de Claridad", "Primer proyecto de cooperación internacional con formación política y audiovisual alternativa junto a OtraEZcuela.", "/media/2022/03/Mocion-de-claridad.jpg"],
  ["2010–2013", "Co-Inspiraciones", "Encuentros nacionales e internacionales: Seminario de Comunicación Juvenil, Medelab, Comunlab, Plataforma Puente, LabSurLab y más.", "/media/2022/03/labsurlab.webp"],
  ["2013", "Laboratorios Comunes de Creación", "Residencias creativas y trabajo con equipamientos públicos para tejer alianzas y procesos colaborativos.", "/media/2022/03/Laboratorios-comunes-de-creacion.png"],
  ["2013", "Manga Libre", "Proceso comunitario de revitalización social de un terreno baldío, convertido en espacio público de uso colectivo.", "/media/2022/03/mangalibre.jpg"],
  ["2013", "Intromisiones pedagógicas", "Producción audiovisual en 14 instituciones con actividades para niñxs y adolescentes en jornadas escolares complementarias.", "/media/2022/03/inststituciones-educativas.png"],
  ["2014", "La Jaquer EsCool", "Escuelita hacker creada desde el interés de niñxs y jóvenes por tecnologías, cuerpo, naturaleza y experimentación.", "/media/2022/03/la-jaquer.jpg"],
  ["2014–actualidad", "Arts Collaboratory", "Red internacional para conocimiento libre, sostenibilidad y creación y gestión en red, clave para la proyección organizacional.", "/media/2022/03/ARTS.jpg"],
  ["2014–2016", "Ondas expansivas", "Producción audiovisual de CuBOX junto a C3P y AC; publicación y visibilización de jóvenes como artistas hackers.", "/media/2022/03/ondas.jpg"],
  ["2015", "Proyección al 2020", "Actualización de misión, visión, enfoques y estructura: Salvaguardia, D-Formación, Residencias y Comunicación Libre y Compartida.", "/media/2022/03/2020.png"],
  ["2015", "MDE15", "Anfitrionxs del Encuentro Internacional de Arte de Medellín y procesos de creación colaborativa con artistas locales e internacionales.", "/media/2022/03/mde15.jpg"],
  ["2016", "CreAcción", "Reinvención de Foco Crítico hacia apoyo a iniciativas y emprendimientos juveniles desde autoevaluación y aprendizaje colectivo.", "/media/2022/03/Creaccion.jpg"],
  ["2018", "FemArtNet", "Proyecto con perspectiva de género, arte feminista y derechos humanos que llegó a la Bienal de Arte Joven de Moscú.", "/media/2022/03/FANMM-WEB.png"],
  ["2019", "Next-Generation Prince Claus Fund", "Consolidación de una nueva generación de jóvenes con espíritu crítico, autonomía creativa y búsqueda del Buen Vivir Común.", "/media/2022/03/netx-gen.png"],
  ["2019", "Multiversos", "Publicación escrita a muchas manos que recoge historia, aprendizajes y metodologías de los primeros 15 años de Platohedro.", "/media/2022/03/Multiversos.jpg"],
  ["2019", "Platoteca", "Acervo documental digital y físico de consulta abierta para la comunidad, basado en cultura libre.", "/media/2022/03/platoteca.png"],
  ["2020", "Curaduría para el Buen Vivir Común", "Investigación sobre lo común en la cultura, desde contexto local, Sur Global y voces del ecosistema Platohedro.", "/media/2022/03/curaduria-para-el-buen-vivir.png"],
  ["2021", "Cypher_Platxs", "Grupo de estudio de intercambio cripto para imaginar economías alternativas y futuros compartidos del Buen Vivir.", "/media/2022/04/cypherplatxs.jpg"],
  ["2022", "Plan Maestro a 2027", "Nuevo plan estratégico para renovación organizacional e infraestructura, impulsado por investigación en sostenibilidad.", "/media/2022/03/2027.png"],
] as const;
...
const team = [
  ["Cristina Correa", "Administradora", "/media/2025/03/IMG_1561-768x1024.jpg"],
  ["Alexander Correa", "Co-Director", "/media/2025/03/IMG_1522-768x1024.jpg"],
  ["Lina Mejía", "Co-Directora", "/media/2025/03/IMG_1384-768x1024.jpg"],
  ["Yuliana Rodríguez", "Coordinadora de Educación", "/media/2025/03/IMG_1420-768x1024.jpg"],
  ["Shara Castaño", "Coordinadora de Educación", "/media/2025/03/IMG_1458-768x1024.jpg"],
  ["Kenny Paternina", "Comunicador", "/media/2025/03/kenny-768x1024.jpg"],
  ["Juan Jaramillo", "Coordinador de Comunicaciones", "/media/2025/03/IMG_1504-768x1024.jpg"],
  ["Sandra Ramirez", "Coordinadora de arte y pensamiento", "/media/2026/08/photo_2026-08-10_01-02-23.jpg"],
] as const;
